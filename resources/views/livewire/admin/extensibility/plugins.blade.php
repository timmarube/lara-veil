...
new class extends Component {
    public function toggle(Plugin $plugin, PluginManager $pluginManager)
    {
    ...
    public function with(PluginManager $pluginManager)
    {
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <flux:button 
                            ...
                            class="w-full" 
                            :variant="$plugin->status === 'active' ? 'ghost' : 'primary'"
                        >
