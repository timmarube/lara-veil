...
class MediaForgeService
{
    ...
    public function save()
    {
        ...
        foreach ($pathList as $path) {
            ...
            if (!file_exists($fullPath)) {
                $fullPath = $this->privateUpload
                 ...
                 // If path is "media/..." normalization might have affected it. 
            ...
            $media = new Media([
                ...
                'manipulations' => $this->operations,
                'custom_properties' => [],
            ]);
            
            if ($this->relatedModel) {
                $media->model()->associate($this->relatedModel);
            }
        ...
        return count($mediaRecords) === 1 ? $mediaRecords[0] : $mediaRecords;
    }
